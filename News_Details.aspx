<%@ Page Title="تفاصيل الخبر" Language="VB" MasterPageFile="~/Master.master" AutoEventWireup="false" CodeFile="News_Details.aspx.vb" Inherits="News_Details" %>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title text-center">
                        <span class="subtitle">News Details</span>
                        <h2 class="title">تفاصيل الخبر</h2>
                    </div>
                </div>
            </div>
