<%@ Page Theme="Theme1" Language="VB" AutoEventWireup="false" CodeFile="Slider.aspx.vb" Inherits="Slider" %>
            ...
            <ContentTemplate>
                ...
                <div id="page-wrapper" style="min-height: 684px;">
                                            ...
                                            <div class="row">
                                                <div class="input-280 input-in searchContiner pull-right">
                                                    <div class="input-group">
                                                        <asp:TextBox ID="txtSearch" runat="server" type="text" placeholder="بحث بالوصف" AutoPostBack="true" OnTextChanged="FillGrid" onkeypress="return isString(event);" onkeyup="ValidateChars(this);ShowHideClearSearch(this.value);" ToolTip="بحث بالوصف"></asp:TextBox>
                                ...
                                <div class="col-md-12">
                                    <div class="table-layer" style="box-shadow: 0px 1px 15px 1px rgba(69,65,78,0.08);">
                                        <div class="table-responsive mt5">
                                            ...
                                            <asp:GridView ID="gvSlider" CssClass="table Pagination-table" runat="server" AutoGenerateColumns="false" AllowSorting="true" OnPageIndexChanging="gvSlider_PageIndexChanging"
                                                AllowPaging="true" PageSize='<%# ddlPager.SelectedValue  %>' OnSorting="gv_Sorting">
                                                <Columns>
                                                     <asp:TemplateField HeaderText="العنوان" SortExpression="Description" HeaderStyle-CssClass="upnDownArrow">
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="الرابط" SortExpression="URL" HeaderStyle-CssClass="upnDownArrow">
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="الصورة" SortExpression="Photo">
                                                        <ItemTemplate>
                                                            <a href='<%# Eval("MediaPath").ToString.Replace("~/", "../")%>' onclick="ImagePreview(this.href);return false;">
                                                                <asp:Image ID="imgPhoto" CssClass="td-img img-thumbnail" runat="server" ImageUrl='<%# Eval("MediaPath")%>' Width="50px" Height="40px" /></a>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                ...
                                                <EmptyDataTemplate>
                                                    <span class="glyphicon glyphicon-exclamation-sign"></span>&nbsp لاتوجد بيانات
                                                </EmptyDataTemplate>
                                            </asp:GridView>
                                        </div>
                                    </div>
                            ...
                            <ul class="btn-uls pull-right">
                                <li class="btn-lis">
                                    <span style="position: relative;">
                                        ...
                                        <asp:Button ID="cmdSave" SkinID="btn-save" ValidationGroup="vSlider" OnClick="Save" runat="server" Text="حفظ" ToolTip="حفظ" />
                                    </span>
                                </li>
                                <li class="btn-lis">
                    ...
                    <asp:Panel ID="pnlForm" runat="server" Visible="false">
                        <div class="container-fluid">
                            <div class="row">
                                <asp:ValidationSummary ID="ValidationSummary" CssClass="validation-message" DisplayMode="BulletList" ValidationGroup="vSlider" EnableClientScript="true" runat="server" Font-Size="Medium" ForeColor="#CC0000" />
                                            ...
                                            <div class="panel panel-default">
                                                <div class="panel-heading" role="tab" id="heading1">
                                                    <h4 class="panel-title">
                                                        <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse1">البيانات</a>
                                                    </h4>
                                                </div>
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" CssClass="displaynone"
                                                                        ValidationGroup="vSlider" ControlToValidate="txtOrderNo" ErrorMessage="أدخل ترتيب العرض"></asp:RequiredFieldValidator>
                                                                </div>
                                                                  <div class="col-md-4">
                                                                    <label>العنوان</label>
                                                                    <asp:TextBox runat="server" ID="txtTitle" MaxLength="400"></asp:TextBox>
                                                                </div>
                                                                ...
                                                                <div class="col-md-12">
                                                                    <label>الوصف</label>
                                                                    <asp:TextBox runat="server" ID="txtCaption" TextMode ="MultiLine"  ></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <fieldset>
                                                ...
                                                <asp:Panel ID="pnlTLCopy" runat="server" CssClass="demo-upload-container pb5">
                                                    <div class="custom-file-container">
                                                        ...
                                                        <asp:HyperLink ID="hlViewSlider" CssClass="custom-file-container__image-preview h-img-pre" runat="server" ClientIDMode="Static" Target="_blank">
                                                            <asp:Image ID="imgSlider" ClientIDMode="Static" runat="server" Style="max-height: 100%; max-width: 100%" ImageUrl="~/images/img-up.png" />
                                                        </asp:HyperLink>
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" CssClass="displaynone"
                                                            ValidationGroup="vSlider" ControlToValidate="HiddenSliderImg" ErrorMessage="تحميل الصورة"></asp:RequiredFieldValidator>

                                                        <asp:Panel ID="pnlfuPhoto" runat="server" CssClass="photo-upload-box_inactive">
                                                            <label class="custom-file-container__custom-file">
                                                                <asp:AsyncFileUpload ID="fuPhoto" CssClass="inputfile inputfile-1" runat="server" OnUploadedComplete="SliderPhotoUploaded"
