<%@ Page Theme="Theme1" Language="VB" AutoEventWireup="false" CodeFile="TeamWork.aspx.vb" Inherits="TeamWork" %>
...
<head runat="server">
    ...
    <script src="JSCode/UploadPhotoTeamWork.js"></script>
    <script src="JSCode/UploadCV.js"></script>
</head>
<body>
            ...
            <ContentTemplate>
                ...
                <div id="page-wrapper" style="min-height: 684px;">
                                            ...
                                            <div class="row">
                                                <div class="input-280 input-in searchContiner pull-right">
                                                    <div class="input-group">
                                                        <asp:TextBox ID="txtSearch" runat="server" type="text" placeholder="بحث بالأسم اوالوظيفة " AutoPostBack="true" OnTextChanged="FillGrid" onkeypress="return isString(event);" onkeyup="ValidateChars(this);ShowHideClearSearch(this.value);" ToolTip="بحث بالأسم اوالوظيفة"></asp:TextBox>
                                ...
                                <div class="col-md-12">
                                    <div class="table-layer" style="box-shadow: 0px 1px 15px 1px rgba(69,65,78,0.08);">
                                        <div class="table-responsive mt5">
                                            ...
                                            <asp:GridView ID="gvTeamWork" CssClass="table Pagination-table" runat="server" AutoGenerateColumns="false" AllowSorting="true" OnPageIndexChanging="gvTeamWork_PageIndexChanging"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="الوظيفة" SortExpression="Title" HeaderStyle-CssClass="upnDownArrow">
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="السيرة الذاتية" SortExpression="CV">
                                                        <ItemTemplate>
                                                            <a href='<%# Eval("CV").ToString.Replace("~/", "../")%>' target="_blank" title="تحميل">
                                                ...
                                                <EmptyDataTemplate>
                                                    <span class="glyphicon glyphicon-exclamation-sign"></span>&nbsp لا توجد بيانات لفريق العمل
                                                </EmptyDataTemplate>
                                            </asp:GridView>
                                        </div>
                                    </div>
                            ...
                            <ul class="btn-uls pull-right">
                                <li class="btn-lis">
                                    <span style="position: relative;">
                                        ...
                                        <asp:Button ID="cmdSave" SkinID="btn-save" ValidationGroup="vTeamWork" OnClick="Save" runat="server" Text="حفظ" ToolTip="حفظ" />
                                    </span>
                                </li>
                                <li class="btn-lis">
                    ...
                    <asp:Panel ID="pnlForm" runat="server" Visible="false">
                        <div class="container-fluid">
                            <div class="row">
                                <asp:ValidationSummary ID="ValidationSummary" CssClass="validation-message" DisplayMode="BulletList" ValidationGroup="vTeamWork" EnableClientScript="true" runat="server" Font-Size="Medium" ForeColor="#CC0000" />
                                <asp:Label ID="lblTeamWorkId" runat="server" Visible="false"></asp:Label>
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" CssClass="displaynone"
                                                                        ValidationGroup="vTeamWork" ControlToValidate="txtName" ErrorMessage="أدخل الأسم"></asp:RequiredFieldValidator>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" CssClass="displaynone"
                                                                        ValidationGroup="vTeamWork" ControlToValidate="txtTitle" ErrorMessage="أدخل الوظيفة"></asp:RequiredFieldValidator>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" CssClass="displaynone"
                                                                        ValidationGroup="vTeamWork" ControlToValidate="txtOrderNo" ErrorMessage="أدخل ترتيب العرض"></asp:RequiredFieldValidator>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <label>الوصف</label>
                                                                    ...
                                                                    <asp:Panel ID="pnlCV" runat="server">
                                                                        <div class="photoPad">
                                                                            <div class="photo div-clear-photo">
                                                                                <asp:HyperLink ID="hlViewCV" runat="server" ClientIDMode="Static" Target="_blank">
                                                                                    <asp:Image ID="imgCV" ClientIDMode="Static" runat="server" Width="110px" ImageUrl="~/images/noDoc.png" />
                                                                                </asp:HyperLink>
                                                                                <asp:TextBox ID="HiddenCV" runat="server" ClientIDMode="Static" Style="display: none"></asp:TextBox>
                                                                                <div class="update-progress-img">
                                                                                    <asp:Image ID="imgLoaderCV" runat="server" ClientIDMode="Static" ImageUrl="~/images/image-uploader.gif" Style="display: none; width: 20px" />
                                                                                </div>
                                                                                <asp:LinkButton ID="btnClear" CssClass="btn-clear-photo" runat="server" OnClick="ClearCV"><i class="ti-close"></i></asp:LinkButton>
                                                                            </div>
                                                                            <div class="clear">
                                                                            </div>
                                                                            <asp:Panel ID="Panel1" runat="server" CssClass="photo-upload-box_inactive "></asp:Panel>
                                                                            <div class="photo-upload-box">
                                                                                <span>تحميل السيرة الذاتية</span>
                                                                                <asp:AsyncFileUpload ID="fuCV" CssClass="photo-upload-box-input inputfile-1" runat="server" OnUploadedComplete="CVUploaded"
                                                                                    OnClientUploadComplete="UploadCompleteCV" OnClientUploadError="UploadErrorCV" OnClientUploadStarted="UploadStartedCV"
                                            ...
                                            <fieldset>
                                                ...
                                                <asp:Panel ID="pnlTLCopy" runat="server" CssClass="demo-upload-container pb5">
                                                    <div class="custom-file-container">
                                                        ...
                                                        <asp:HyperLink ID="hlViewTeamWork" CssClass="custom-file-container__image-preview h-img-pre" runat="server" ClientIDMode="Static" Target="_blank">
                                                            <asp:Image ID="imgTeamWork" ClientIDMode="Static" runat="server" Style="max-height: 100%; max-width: 100%" ImageUrl="~/images/img-up.png" />
                                                        </asp:HyperLink>
                                                        <asp:TextBox ID="HiddenTeamWorkImg" runat="server" ClientIDMode="Static" Style="display: none"></asp:TextBox>
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" CssClass="displaynone"
                                                            ValidationGroup="vTeamWork" ControlToValidate="HiddenTeamWorkImg" ErrorMessage="تحميل الصورة"></asp:RequiredFieldValidator>

                                                        <asp:Panel ID="pnlfuPhoto" runat="server" CssClass="photo-upload-box_inactive">
                                                            <label class="custom-file-container__custom-file">
                                                                <asp:AsyncFileUpload ID="fuPhoto" CssClass="inputfile inputfile-1" runat="server" OnUploadedComplete="TeamWorkPhotoUploaded"
