<%@ Page Theme="Theme1" Language="VB" AutoEventWireup="false" CodeFile="Seminars.aspx.vb" Inherits="Seminars" %>
                                                    ...
                                                    <tr id="lvItemRow" runat="server">
                                                        ...
                                                        <td id="Delete">
                                                            ...
                                                            <asp:Panel ID="pnlConfirmExtenderDelete" runat="server" CssClass="modal-n modalPopup" align="center" Style="display: none">
                                                                ...
                                                                <div class="body">
                                                                    <label>هل تريد حذف الندوة ؟</label>
                                                                </div>
                                            ...
                                            <div class="panel panel-default">
                                                <div class="panel-heading" role="tab" id="heading1">
                                                    <h4 class="panel-title">
                                                        <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse1">بيانات الندوة</a>
                                                    </h4>
                                                </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                ...
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" Text="أدخل تاريخ الندوة" ValidationGroup="vNews"
