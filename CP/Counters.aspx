<%@ Page Theme="Theme1" Language="VB" AutoEventWireup="false" CodeFile="Counters.aspx.vb" Inherits="Counters" %>
...
<head runat="server">
    ...
    <script src="JSCode/UploadPhotoCounter.js"></script>
            ...
            <ContentTemplate>
                ...
                <div id="page-wrapper" style="min-height: 684px;">
                                ...
                                <div class="col-md-12">
                                    <div class="table-layer" style="box-shadow: 0px 1px 15px 1px rgba(69,65,78,0.08);">
                                        <div class="table-responsive mt5">
                                            ...
                                            <asp:GridView ID="gvCounter" CssClass="table Pagination-table" runat="server" AutoGenerateColumns="false" AllowSorting="true" OnPageIndexChanging="gvCounter_PageIndexChanging"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="تحديث">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lbEdit" CssClass="btni-xxxs btn-info brd-50" runat="server" CommandArgument='<%# Eval("ID")%>' OnClick="Edit" ToolTip="تحديث"><i class="fa-edit fa"></i></asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="حذف">
                                                        <ItemTemplate>
                                                            <a href="#" id="hrefDelete" class="btni-xxxs btn-red brd-50" title="حذف"
                                                ...
                                                <EmptyDataTemplate>
                                                    <span class="glyphicon glyphicon-exclamation-sign"></span>&nbsp لا توجد عدادات
                                                </EmptyDataTemplate>
                                            </asp:GridView>
                                        </div>
                                    </div>
                            ...
                            <ul class="btn-uls pull-right">
                                <li class="btn-lis">
                                    <span style="position: relative;">
                                        ...
                                        <asp:Button ID="cmdSave" SkinID="btn-save" ValidationGroup="vCounter" OnClick="Save" runat="server" Text="حفظ" ToolTip="حفظ" />
                                    </span>
                                </li>
                                <li class="btn-lis">
                                    ...
                                    <asp:Panel runat="server" ID="pnlCancel">
                                        <a id="cmdCancel" href="#" title="إلغاء" class="btn-main btn-red" data-toggle="modal" data-placement="bottom" data-original-title="Cancel"
                    ...
                    <asp:Panel ID="pnlForm" runat="server" Visible="false">
                        <div class="container-fluid">
                            <div class="row">
                                <asp:ValidationSummary ID="ValidationSummary" CssClass="validation-message" DisplayMode="BulletList" ValidationGroup="vCounter" EnableClientScript="true" runat="server" Font-Size="Medium" ForeColor="#CC0000" />
                                <asp:Label ID="lblCounterId" runat="server" Visible="false"></asp:Label>
                                            ...
                                            <div class="panel panel-default">
                                                <div class="panel-heading" role="tab" id="heading1">
                                                    <h4 class="panel-title">
                                                        <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse1">بيانات العداد</a>
                                                    </h4>
                                                </div>
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" CssClass="displaynone"
                                                                        ValidationGroup="vCounter" ControlToValidate="txtOrderNo" ErrorMessage="أدخل ترتيب العداد"></asp:RequiredFieldValidator>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <label class="required">القمية</label>
                                                                    <asp:TextBox runat="server" ID="txtvalue" MaxLength="2" onkeypress="return isDecimal(event,this);"></asp:TextBox>
                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" CssClass="displaynone"
                                                                        ValidationGroup="vCounter" ControlToValidate="txtvalue" ErrorMessage="أدخل قمية العداد"></asp:RequiredFieldValidator>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" CssClass="displaynone"
                                                                        ValidationGroup="vCounter" ControlToValidate="txtTitle" ErrorMessage="أدخل العنوان"></asp:RequiredFieldValidator>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <fieldset>
                                                ...
                                                <asp:Panel ID="pnlTLCopy" runat="server" CssClass="demo-upload-container pb5">
                                                    <div class="custom-file-container">
                                                        ...
                                                        <asp:HyperLink ID="hlViewCounter" CssClass="custom-file-container__image-preview h-img-pre" runat="server" ClientIDMode="Static" Target="_blank">
                                                            <asp:Image ID="imgCounter" ClientIDMode="Static" runat="server" Style="max-height: 100%; max-width: 100%" ImageUrl="~/images/img-up.png" />
                                                        </asp:HyperLink>
                                                        <asp:TextBox ID="HiddenCounterImg" runat="server" ClientIDMode="Static" Style="display: none"></asp:TextBox>
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" CssClass="displaynone"
                                                            ValidationGroup="vCounter" ControlToValidate="HiddenCounterImg" ErrorMessage="تحميل صورة العداد"></asp:RequiredFieldValidator>

                                                        <asp:Panel ID="pnlfuPhoto" runat="server" CssClass="photo-upload-box_inactive">
                                                            <label class="custom-file-container__custom-file">
                                                                <asp:AsyncFileUpload ID="fuPhoto" CssClass="inputfile inputfile-1" runat="server" OnUploadedComplete="CounterPhotoUploaded"
