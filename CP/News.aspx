<%@ Page Language="VB" AutoEventWireup="false" CodeFile="News.aspx.vb" Inherits="News" Theme="Theme1" %>
                                ...
                                <div class="tab-pane active" id="edit">
                                    ...
                                    <div class="col-md-12 p0">
                                        <div class="mb0" id="accordion" role="tablist" aria-multiselectable="false">
                                                            ...
                                                            <ul class="pull-right p0">
                                                                <li class="btn-lis" id="liSave" runat="server">
                                                                    <span class="btn-save-wrapper" style="position: relative;">
                                                                        ...
                                                                        <asp:Button ID="cmdSave" ValidationGroup="vNews" runat="server" SkinID="btn-save" UseSubmitBehavior="false" OnClientClick="SaveClick(this,'vNews');" ToolTip="حفظ" Text="حفظ" OnClick="Save"></asp:Button>
                                                                    </span>
                                                                </li>
                                                            ...
                                                            <div class="panel panel-default">
                                                                <div class="panel-heading">
                                                                    <h4 class="panel-title">
                                                                        <a class="accordion-toggle" data-toggle="collapse" href="#collapseOne">إضافة خبر</a>
                                                                    </h4>
                                                                </div>
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-12">
                                                                                ...
                                                                                <div class="col-md-3">
                                                                                    ...
                                                                                    <asp:TextBox ID="txtNewsDate" runat="server" MaxLength="10" onkeypress="return isDate(event);"></asp:TextBox>
                                                                                    <asp:CalendarExtender CssClass="custom-calendar" ID="CalendarExtender1" runat="server"
                                                                                        Enabled="True" TargetControlID="txtNewsDate" DaysModeTitleFormat="dd/MM/yyyy"
                                                                                        TodaysDateFormat="dd/MM/yyyy" Format="dd/MM/yyyy">
                                                                                    </asp:CalendarExtender>
                                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" Text="أدخل تاريخ الخبر" ValidationGroup="vNews"
                                                                                        ControlToValidate="txtNewsDate" EnableClientScript="true" Display="Dynamic" SetFocusOnError="true" ErrorMessage="Required News Date"></asp:RequiredFieldValidator>
                                                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator3" ValidationGroup="vNews" runat="server"
                                                                                        ErrorMessage="Invalid News Date" ControlToValidate="txtNewsDate" Display="Dynamic"
                                            ...
                                            <asp:Panel ID="pnlPhotos" runat="server" ClientIDMode="Static" Style="display: none" CssClass="col-md-12 p0">
                                                <div class="panel panel-default">
                                                    <div class="panel-heading">
                                                        <h4 class="panel-title">
                                                            ...
                                                            <div class="header_area">
                                                                <asp:Panel ID="pnlUpload" runat="server" ClientIDMode="Static">
                                                                    ...
                                                                    <asp:Panel ID="pnlFileUpload" runat="server" CssClass="modalPopup-uploader" Style="width: 500px;">
                                                                        ...
                                                                        <asp:HiddenField ID="FolderName" runat="server" Value="MediaCenter/News/" />
                                        ...
                                        <asp:Panel runat="server" ID="pnlList">
                                            ...
                                            <div class="table-layer" style="box-shadow: 0px 1px 15px 1px rgba(69,65,78,0.08);">
                                                <div class="pages-table">
                                                    <asp:ListView ID="lvNews" runat="server" ClientIDMode="AutoID"
                                                        ...
                                                        <LayoutTemplate>
                                                            <table id="itemPlaceholderContainer" runat="server" class="table tbl-table">
                                                                <tr class="HeaderStyle">
                                                                    <th>م</th>
                                                                    <th class="upnDownArrow" id="NewsDate">
                                                                        <asp:LinkButton ID="lbNewsDate" CommandArgument="NewsDate" CommandName="Sort" runat="server">آخر تحديث</asp:LinkButton>
                                                                    </th>
                                                                    <th>الصور</th>
                                                        ...
                                                        <ItemTemplate>
                                                            <tr id="lvItemRow" runat="server">
                                                                <td>
                                                                    <asp:Label ID="srialNo" runat="server" Text='<%# Val(Container.DataItemIndex.ToString) + 1 %>'></asp:Label>
                                                                    <asp:Label ID="lblNewsID" runat="server" Text='<%# Eval("Id") %>' Visible="false"></asp:Label>
                                                                </td>
                                                                <td>
                                                                    <asp:Label runat="server" Text='<%# PublicFunctions.DateFormat(Eval("NewsDate").ToString, "dd/MM/yyyy") %>'></asp:Label>
                                                                </td>
                                                                <td>
                                                                    ...
                                                                    <asp:LinkButton ID="lbShowImages" runat="server" CommandArgument='<%# Eval("ID")%>' OnClick="ViewPhotos">
                                                                        <asp:Image ID="imgPhoto" CssClass="td-img img-thumbnail" runat="server" ImageUrl='<%# IIf(Eval("MediaPath").ToString <> String.Empty, Eval("MediaPath"), "../images/noimage.jpg")%>' />
                                                                    </asp:LinkButton>
                                            ...
                                            <div class="table-bot-panel">
                                                ...
                                                <div class="tbl-bot-panel-right">
                                                    <div class="row">
                                                        <ul class="pagination">
                                                            <li>
                                                                <asp:DataPager ID="dplvNews" class="pagination" runat="server" PagedControlID="lvNews" PageSize='<%# ddlPager.SelectedValue %>' style="width: 100%; display: inline-flex;">
                                                                    <Fields>
