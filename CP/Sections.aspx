<%@ Page Theme="Theme1" Language="VB" AutoEventWireup="false" CodeFile="Sections.aspx.vb" Inherits="Section" %>
...
<head runat="server">
    ...
    <script src="JSCode/UploadPhotoSection.js"></script>
            ...
            <ContentTemplate>
                ...
                <div id="page-wrapper" style="min-height: 684px;">
                                ...
                                <div class="col-md-12">
                                    <div class="table-layer" style="box-shadow: 0px 1px 15px 1px rgba(69,65,78,0.08);">
                                        <div class="table-responsive mt5">
                                            ...
                                            <asp:GridView ID="gvSection" CssClass="table Pagination-table" runat="server" AutoGenerateColumns="false" AllowSorting="true" OnPageIndexChanging="gvSection_PageIndexChanging"
                                                ...
                                                <EmptyDataTemplate>
                                                    <span class="glyphicon glyphicon-exclamation-sign"></span>&nbsp لا توجد اقسام
                                                </EmptyDataTemplate>
                                            </asp:GridView>
                                        </div>
                                    </div>
                            ...
                            <ul class="btn-uls pull-right">
                                <li class="btn-lis">
                                    <span style="position: relative;">
                                        ...
                                        <asp:Button ID="cmdSave" SkinID="btn-save" ValidationGroup="vSection" OnClick="Save" runat="server" Text="حفظ" ToolTip="حفظ" />
                                    </span>
                                </li>
                                <li class="btn-lis">
                    ...
                    <asp:Panel ID="pnlForm" runat="server" Visible="false">
                        <div class="container-fluid">
                            <div class="row">
                                <asp:ValidationSummary ID="ValidationSummary" CssClass="validation-message" DisplayMode="BulletList" ValidationGroup="vSection" EnableClientScript="true" runat="server" Font-Size="Medium" ForeColor="#CC0000" />
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" CssClass="displaynone"
                                                                        ValidationGroup="vSection" ControlToValidate="txtTitle" ErrorMessage="أدخل العنوان"></asp:RequiredFieldValidator>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <label>الوصف</label>
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" CssClass="displaynone"
                                                                        ValidationGroup="vSection" ControlToValidate="txtOrderNo" ErrorMessage="أدخل ترتيب القسم"></asp:RequiredFieldValidator>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <label>الرابط</label>
                                                                ...
                                                                <div class="col-md-6">
                                                                   ...
                                                                   <asp:RadioButtonList ID="rblType" runat ="server" >
                                                                       <asp:ListItem Value ="G1" >المجموعة الاولي</asp:ListItem>
                                                                       <asp:ListItem Value ="G2" >المجموعة الثانية</asp:ListItem>
                                                                   </asp:RadioButtonList>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <fieldset>
                                                ...
                                                <asp:Panel ID="pnlTLCopy" runat="server" CssClass="demo-upload-container pb5">
                                                    <div class="custom-file-container">
                                                        ...
                                                        <asp:TextBox ID="HiddenSectionImg" runat="server" ClientIDMode="Static" Style="display: none"></asp:TextBox>
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" CssClass="displaynone"
                                                            ValidationGroup="vSection" ControlToValidate="HiddenSectionImg" ErrorMessage="تحميل صورة القسم"></asp:RequiredFieldValidator>
