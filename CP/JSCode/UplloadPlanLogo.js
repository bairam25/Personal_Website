...
function UploadComplete(sender, args) {
    ...
    if (url.split(".").pop().toLowerCase() == "pdf") {
        document.getElementById('hlViewSection').href = '../PlanFiles/' + args.get_fileName();
        document.getElementById('imgSection').src = '../Images/pdf_icon.jpg';
        document.getElementById('HiddenWorkAreaImg').value = '~/PlanFiles/' + args.get_fileName();
    }

    else {
        document.getElementById('hlViewSection').href = '../PlanFiles/' + args.get_fileName();
        document.getElementById('imgSection').src = '../PlanFiles/' + args.get_fileName();
        document.getElementById('HiddenWorkAreaImg').value = '~/PlanFiles/' + args.get_fileName();
    }
