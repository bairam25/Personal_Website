...
function UploadComplete(sender, args) {
    ...
    if (url.split(".").pop().toLowerCase() == "pdf") {
        document.getElementById('hlViewSection').href = '../SectionPhotos/' + args.get_fileName();
        document.getElementById('imgSection').src = '../Images/pdf_icon.jpg';
        document.getElementById('HiddenSectionImg').value = '~/SectionPhotos/' + args.get_fileName();
    }

    else {
        document.getElementById('hlViewSection').href = '../SectionPhotos/' + args.get_fileName();
        document.getElementById('imgSection').src = '../SectionPhotos/' + args.get_fileName();
        document.getElementById('HiddenSectionImg').value = '~/SectionPhotos/' + args.get_fileName();
    }
