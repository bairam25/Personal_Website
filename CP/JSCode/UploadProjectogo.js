...
function UploadComplete(sender, args) {
    ...
    if (url.split(".").pop().toLowerCase() == "pdf") {
        //document.getElementById('hlViewSection').href = '../ProjectPhotos/' + args.get_fileName();
        document.getElementById('imgSection').src = '../Images/pdf_icon.jpg';
        document.getElementById('HiddenProjectImg').value = '~/ProjectPhotos/' + args.get_fileName();
    }

    else {
        //document.getElementById('hlViewSection').href = '../ProjectPhotos/' + args.get_fileName();
        document.getElementById('imgSection').src = '../ProjectPhotos/' + args.get_fileName();
        document.getElementById('HiddenProjectImg').value = '~/ProjectPhotos/' + args.get_fileName();
    }
