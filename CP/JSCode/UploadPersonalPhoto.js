...
function UploadComplete(sender, args) {
    ...
    if (url.split(".").pop().toLowerCase() == "pdf") {
        document.getElementById('hlViewContent').href = '../PersonalPhotos/' + args.get_fileName();
        document.getElementById('imgContent').src = '../Images/pdf_icon.jpg';
        document.getElementById('HiddenContentImg').value = '~/PersonalPhotos/' + args.get_fileName();
    }

    else {
        document.getElementById('hlViewContent').href = '../PersonalPhotos/' + args.get_fileName();
        document.getElementById('imgContent').src = '../PersonalPhotos/' + args.get_fileName();
        document.getElementById('HiddenContentImg').value = '~/PersonalPhotos/' + args.get_fileName();
    }
