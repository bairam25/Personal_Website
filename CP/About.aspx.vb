...
#Region "Public_Functions"
    ...
    Sub SetControlFields()
        Try
            ...
            Certificate = txtCertificates.Text
    ...
    Private Function FillForm() As Boolean
        Try
            ...
            If dt.Rows.Count <> 0 Then
                ...
                txtDegree.Text = dt.Rows(0).Item("Degree").ToString
                txtExperience.Text = dt.Rows(0).Item("Experience").ToString
                txtCertificates.Text = dt.Rows(0).Item("Certificates").ToString
                txtSkills.Text = dt.Rows(0).Item("skills").ToString
                txtVision.Text = dt.Rows(0).Item("Vision").ToString
