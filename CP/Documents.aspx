<%@ Page Theme="Theme1" Language="VB" AutoEventWireup="false" CodeFile="Documents.aspx.vb" Inherits="Documents" %>
...
<body>
    <form id="form1" runat="server" enctype="multipart/form-data" autocomplete="off">
        ...
        <asp:UpdatePanel ID="up" runat="server">
            <ContentTemplate>
                  <asp:HiddenField ID="FolderName" runat ="server" Value ="LibraryDocuments/" />
                <!--============================ Page-content =============================-->
                                ...
                                <div class="col-md-12">
                                    <div class="table-top-panel">
                                        ...
                                        <div class="tbl-top-panel-right">
                                            <div class="row">
                                                <div class="input-280 input-in searchContiner pull-right" style="display: none;">
                                ...
                                <div class="col-md-12">
                                    <div class="table-layer" style="box-shadow: 0px 1px 15px 1px rgba(69,65,78,0.08);">
                                        <div class="table-responsive mt5">
                                            ...
                                            <asp:ListView ID="lvLibrary" runat="server" ClientIDMode="AutoID"
                                                ...
                                                <LayoutTemplate>
                                                    <table id="itemPlaceholderContainer" runat="server" class="table tbl-table">
                                                        <tr class="HeaderStyle">
                                                            <th>م</th>
                                                            <th class="upnDownArrow" id="DocCategory">
                                                                <asp:LinkButton ID="LinkButton1" CommandArgument="DocCategory" CommandName="Sort" runat="server">التصنيف</asp:LinkButton>
                                                            </th>
                                                            <th class="upnDownArrow" id="DocSubCategory">
                                                                <asp:LinkButton ID="lbsubC" CommandArgument="DocSubCategory" CommandName="Sort" runat="server">التصنيف الفرعى</asp:LinkButton>
                                                            </th>
                                                ...
                                                <ItemTemplate>
                                                    <tr id="lvItemRow" runat="server">
                                                        <td>
                                                            ...
                                                            <%--<asp:Label ID="lblLibraryCategoryID" runat="server" Text='<%# Eval("Id") %>' Visible="false"></asp:Label>--%>
                                                        </td>
                                                        <td>
                                                            <asp:Label ID="lbCat" runat="server" Text='<%# Eval("DocCategory").ToString %>'></asp:Label>
                                                            <asp:Label ID="lbCategoryId" runat="server" Text='<%# Eval("Category").ToString %>' Visible="false"></asp:Label>
                                                        </td>
                                                        <td>
                                                            <asp:Label ID="lblSubCat" runat="server" Text='<%# Eval("DocSubCategory").ToString %>'></asp:Label>
                                                            <asp:Label ID="lblSubCategoryId" runat="server" Text='<%# Eval("SubCategory").ToString %>' Visible="false"></asp:Label>
                                                        </td>
                                                        <td id="Active">
                                                            <asp:CheckBox runat="server" ID="chkActive" Checked='<%# Eval("Active").ToString %>' AutoPostBack="true" OnCheckedChanged="UpdateActive" />
                                                        </td>
                                                        <td id="Edit">
                                                            <asp:LinkButton ID="lbUpdate" CssClass="btni-xxxs btn-blue brd-50" runat="server" CommandArgument='<%# Eval("Category") %>' OnClick="Edit" ToolTip="تحديث">
                                                            ...
                                                            <asp:Panel ID="pnlConfirmExtenderDelete" runat="server" CssClass="modal-n modalPopup" align="center" Style="display: none">
                                                                ...
                                                                <div class="footer">
                                                                    <ul class="btn-uls mb0">
                                                                        <li class="btn-lis">
                                                                            <asp:LinkButton ID="lbYesDelete" runat="server" SkinID="btn-green" CommandArgument='<%# Eval("Category") %>' OnClick="Delete" CausesValidation="false">نعم<i class="ti-check"></i></asp:LinkButton></li>
                                                                        <li class="btn-lis">
                                    ...
                                    <div class="table-bot-panel">
                                        ...
                                        <div class="tbl-bot-panel-right">
                                            <div class="row">
                                                <ul class="pagination">
                                                    <li>
                                                        <asp:DataPager ID="dplvLibrary" class="pagination" runat="server" PagedControlID="lvLibrary" PageSize='<%# ddlPager.SelectedValue %>' style="width: 100%; display: inline-flex;">
                                                            <Fields>
                    ...
                    <asp:Panel ID="pnlForm" runat="server" Style="display: none;">
                        <div class="container-fluid">
                            <div class="row">
                                ...
                                <asp:Label ID="lblLibraryCategoryID" runat="server" Visible="false"></asp:Label>
                                            ...
                                            <div class="panel panel-default">
                                                <div class="panel-heading" role="tab" id="heading1">
                                                    <h4 class="panel-title">
                                                        <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse1">بيانات الملفات</a>
                                                    </h4>
                                                </div>
                                                ...
                                                <div id="collapse1" class="panel-collapse collapse in">
                                                    <div class="panel-body">
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="col-md-4">
                                                                    <label runat="server" id="Label1" for="ddlCategory" class="required">التصنيف</label>
                                                                    ...
                                                                    <asp:RequiredFieldValidator  CssClass="displaynone" runat="server" ID="rvcat" ControlToValidate="ddlCategory" ValidationGroup="vProjects" ErrorMessage="اختر الفئة" InitialValue="0" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                                                </div>
                                                                <div class="col-md-4">
                                        ...
                                        <div>
                                            <div class="panel panel-default">
                                                <div class="panel-heading" role="tab">
                                                    <h4 class="panel-title">
                                                        <a role="button" data-toggle="collapse" data-parent="#accordionFiles" href="#collapseFiles">الملفات </a>
                                                    </h4>
                                                </div>
                                                                ...
                                                                <asp:GridView ID="gvItemsImgs" CssClass="tbl-imgs tbl-imgs-custom" runat="server"
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="حذف">
                                                                            <ItemTemplate>
                                                                                <a href="#" class="btni-xxxs btn-red brd-50" id="hrefDeleteImg" title="حذف الملف"
