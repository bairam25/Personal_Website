<%@ Page Theme="Theme1" Language="VB" AutoEventWireup="false" CodeFile="AdministrativeDivision.aspx.vb" Inherits="AdministrativeDivision" %>
                                                    ...
                                                    <table id="itemPlaceholderContainer" runat="server" class="table tbl-table">
                                                        <tr class="HeaderStyle">
                                                            ...
                                                            <th class="upnDownArrow" id="Name">
                                                                <asp:LinkButton ID="lbName" CommandArgument="Name" CommandName="Sort" runat="server">التقسيم</asp:LinkButton>
                                                            </th>
                                                            <th>الشعار</th>
                                                            <th class="upnDownArrow" id="CitizenCount">
                                                                <asp:LinkButton ID="lbCitizenCount" CommandArgument="CitizenCount" CommandName="Sort" runat="server">عدد السكان</asp:LinkButton>
                                                            </th>
                                                            <th class="upnDownArrow" id="TotalArea">
                                                                <asp:LinkButton ID="lbTotalArea" CommandArgument="TotalArea" CommandName="Sort" runat="server">المساحة</asp:LinkButton>
                                                            </th>
                                                ...
                                                <ItemTemplate>
                                                    <tr id="lvItemRow" runat="server">
                                                        <td>
                                                            ...
                                                            <asp:Label ID="lblWorkAreaID" runat="server" Text='<%# Eval("Id") %>' Visible="false"></asp:Label>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <img runat="server" class="td-img img-thumbnail" alt='<%# Eval("Name")%>' title='<%# Eval("Name")%>' src='<%# Eval("logo").ToString %>' onclick="ImagePreview(this.src,this.alt)" />
                                                        </td>
                                                        <td>
                                                            <asp:Label runat="server" Text='<%# Eval("CitizenCount").ToString %>'></asp:Label>
                                                        </td>
                                                        <td>
                                                            <asp:Label runat="server" Text='<%# Eval("TotalArea").ToString %>'></asp:Label>
                                                        </td>
                                                        <td>
                    ...
                    <asp:Panel ID="pnlForm" runat="server" Visible="false">
                        <div class="container-fluid">
                            <div class="row">
                                ...
                                <asp:Label ID="lblWorkAreaID" runat="server" Visible="false"></asp:Label>
                                            ...
                                            <div class="panel panel-default">
                                                <div class="panel-heading" role="tab" id="heading1">
                                                    <h4 class="panel-title">
                                                        <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse1">بيانات التقسيم الإداري</a>
                                                    </h4>
                                                </div>
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="col-md-9">
                                                                    ...
                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" CssClass="displaynone"
                                                                        ValidationGroup="vWorkArea" ControlToValidate="rblAreas" ErrorMessage="اختر التقسيم الإداري" InitialValue=""></asp:RequiredFieldValidator>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        <asp:Panel ID="pnlMainDistribution" runat="server">
                                                                            ...
                                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" CssClass="displaynone"
                                                                                ValidationGroup="vWorkArea" ControlToValidate="ddlMainDistribution" ErrorMessage="اختر الإقليم الإداري" InitialValue="0"></asp:RequiredFieldValidator>
                                                                        </asp:Panel>
                                                                    </div>
                                                                    <div class="col-md-3">
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        <asp:Panel ID="pnlCenter" runat="server">
                                                                            ...
                                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" CssClass="displaynone"
                                                                                ValidationGroup="vWorkArea" ControlToValidate="ddlCenter" ErrorMessage="اختر المركز" InitialValue="0"></asp:RequiredFieldValidator>
                                                                        </asp:Panel>
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <asp:Panel ID="pnlUnits" runat="server">
                                                                            ...
                                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" CssClass="displaynone"
                                                                                ValidationGroup="vWorkArea" ControlToValidate="ddlUnits" ErrorMessage="اختر الوحدة المحلية" InitialValue="0"></asp:RequiredFieldValidator>
                                                                        </asp:Panel>
                                                                    </div>
                                                                </div>
                                                            </asp:Panel>
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" CssClass="displaynone"
                                                                            ValidationGroup="vWorkArea" ControlToValidate="txtName" ErrorMessage="ادخل الاسم"></asp:RequiredFieldValidator>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <label>الوصف</label>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <asp:TextBox runat="server" ID="txtCitizenCount" MaxLength="200"></asp:TextBox>
                                                                        <%--<asp:FilteredTextBoxExtender runat="server" FilterType="Numbers" TargetControlID="txtCitizenCount"></asp:FilteredTextBoxExtender>--%>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <label>المساحة</label>
                                                                        <asp:TextBox runat="server" ID="txtTotalArea" MaxLength="200" ></asp:TextBox>
                                                                        <%--<asp:FilteredTextBoxExtender runat="server" FilterType="Custom" FilterMode="ValidChars" ValidChars="0123456789." TargetControlID="txtTotalArea"></asp:FilteredTextBoxExtender>--%>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                    ...
                                                                    <asp:Panel ID="pnlMap" runat="server" CssClass="col-md-2 mt25">
                                                                     ...
                                                                     <div class="col-md-6">
                                                                        ...
                                                                        <asp:TextBox runat="server" ID="txtLocationRemarks" ></asp:TextBox>
                                                                        <%--<asp:FilteredTextBoxExtender runat="server" FilterType="Custom" FilterMode="ValidChars" ValidChars="0123456789." TargetControlID="txtTotalArea"></asp:FilteredTextBoxExtender>--%>
                                                                    </div>
                                                                </div>
                                                            </asp:Panel>
